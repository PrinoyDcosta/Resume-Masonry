...
export const withDNDForm = <P extends {}, T>(Component : React.ComponentType<P>, title: string, setViewMode: () => void, data: T[], updateData: (newData: Array<T>, title?: string) => void ) => {
